...
UI_page1ViewBase::UI_page1ViewBase()
{
    ...
    mast_angle_text.setTypedText(touchgfx::TypedText(T___SINGLEUSE_6NEM));
    mast_angle_container.add(mast_angle_text);

    mast_angle_title.setXY(11, 111);
    mast_angle_title.setColor(touchgfx::Color::getColorFromRGB(255, 255, 255));
    mast_angle_title.setLinespacing(0);
    mast_angle_title.setTypedText(touchgfx::TypedText(T___SINGLEUSE_ACSH));
    ...
    pitch_text.setTypedText(touchgfx::TypedText(T___SINGLEUSE_DQ6P));
    ...
    pitch_title.setTypedText(touchgfx::TypedText(T___SINGLEUSE_Z9YY));
    ...
    wind_speed_text.setTypedText(touchgfx::TypedText(T___SINGLEUSE_VF66));
    ...
    wind_speed_title.setTypedText(touchgfx::TypedText(T___SINGLEUSE_BDA3));
    ...
    wind_dir_text.setTypedText(touchgfx::TypedText(T___SINGLEUSE_A1X8));
    ...
    wind_dir_title.setTypedText(touchgfx::TypedText(T___SINGLEUSE_DKX9));
    ...
    wheel_rpm_text.setTypedText(touchgfx::TypedText(T___SINGLEUSE_QIHN));
    wheel_rpm_container.add(wheel_rpm_text);

    wheel_rpm_title.setXY(11, 108);
    wheel_rpm_title.setColor(touchgfx::Color::getColorFromRGB(255, 255, 255));
    wheel_rpm_title.setLinespacing(0);
    wheel_rpm_title.setTypedText(touchgfx::TypedText(T___SINGLEUSE_4D63));
    ...
    turb_rpm_text.setTypedText(touchgfx::TypedText(T___SINGLEUSE_95PI));
    ...
    turb_rpm_title.setTypedText(touchgfx::TypedText(T___SINGLEUSE_HA9B));
